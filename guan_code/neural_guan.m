function [result] = neural_guan(feature,long,wainput)
...
%  save('X_train.mat','X')
%  save('Y_npr_train.mat','Y_npr')

% 
X_test = feature;

Y_produce = neural_try(X,Y_npr,X_test);

result = find(Y_produce==max(Y_produce))-1;
